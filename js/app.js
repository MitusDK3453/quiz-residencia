...
try {
  // Verifica autenticação (comentado temporariamente para desenvolvimento)
  ...
  */
  ...
  // Modo desenvolvimento - acesso direto (remova quando ativar autenticação)
  const menu = document.getElementById('menu-lateral');
  if (menu) menu.style.display = 'flex';
  loadUser();
  carregarQuestoesBackup();
...
try {
  ...
  // Menu sempre visível - não precisa mais de lógica de estado
} catch (e) {
